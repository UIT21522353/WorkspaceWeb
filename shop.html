    ...
    <div class="container">
      ...
      <div class="row trending-box">
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            <div class="thumb">
              ...
              <span class="price"><em>700.000Đ</em>499.000Đ</span>
            </div>
            <div class="down-content">
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac adv">
          <div class="item">
            <div class="thumb">
              ...
              <span class="price"><em>800.000Đ</em>600.000Đ</span>
            </div>
            <div class="down-content">
              <span class="category">Action</span>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            <div class="thumb">
              ...
              <span class="price"><em>1.650.000Đ</em>1.000.000Đ</span>
            </div>
            <div class="down-content">
              <span class="category">Adventure</span>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv rac">
          <div class="item">
            <div class="thumb">
              ...
              <span class="price"><em>900.000Đ</em>749.000Đ</span>
            </div>
            <div class="down-content">
              <span class="category">Action</span>
              <h4>ELDER RING</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/categories-06.jpg" alt=""></a>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/categories-07.jpg" alt=""></a>
              <span class="price"><em>1.200.000Đ</em>750.000Đ</span>
            </div>
            <div class="down-content">
              <span class="category">Shooter</span>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/categories-08.jpg" alt=""></a>
              <span class="price"><em>900.000Đ</em>499.000Đ</span>
            </div>
            <div class="down-content">
              <span class="category">Shooter</span>
              <h4>OVERWATCH</h4>
